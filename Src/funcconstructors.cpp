...
createdfunc addition = createdfunc("addition",2,[](vector<errval>a){return a[0]+a[1];});
createdfunc multiplication = createdfunc("multiplication",2,[](vector<errval>a){return a[0]*a[1];});
createdfunc division = createdfunc("division",2,[](vector<errval>a){return a[0]/a[1];});
createdfunc power = createdfunc("power",2,[](vector<errval>a){return pow(a[0],a[1]);});
